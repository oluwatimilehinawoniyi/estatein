...
export default function About() {
  return (
    <>
      ...
      <section className='padding py-14'>
        <div className="max-w-[1400px] mx-auto flex flex-col md:flex-row md:items-end gap-4 md:gap-6">
          ...
          <div className="grid grid-cols-2 grid-rows-2 gap-8 md-w-1/6">
