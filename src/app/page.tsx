        ...
        <div className="flex md:flex-row-reverse flex-col gap-4 py-4 md:h-[480px] md:items-end md:gap-6">
          ...
          <div className="w-full flex flex-col gap-4 justify-between relative pt-4 md:pt-0 md:gap-8">
            ...
            <div className="space-y-2">
              <h1 className="lg:text-[46px] font-semibold text-[28px] leading-[120%] capitalize md:w-4/5">Discover your dream property with estatein</h1>
            ...
            <div className="flex flex-col md:w-2/3 items-center md:flex-row gap-4">
              <Button className="bg-background hover:bg-primary w-full md:py-4">learn more</Button>
              <Button className="bg-primary hover:bg-background hover:border-primary w-full md:py-4">browse properties</Button>
            </div>
