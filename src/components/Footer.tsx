...
export default function Footer() {
    return (
        <footer className="paddin border-t border-border ">
            <div className="flex items-center flex-col justify-between">
                {/* Top Section */}
                <div className="padding w-full">
                    <div className="max-w-[1400px] mx-auto w-full justify-between py-10 flex flex-wrap gap-8">
                        {/* Logo & Newsletter */}
                ...
                <div className="padding bg-background-grey w-full">
                    <div className=" max-w-[1400px] mx-auto py-2 flex flex-col md:flex-row justify-between items-center w-full gap-2">
