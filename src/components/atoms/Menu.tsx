...
export default function Menu({ isOpen, toggleMenu }: { isOpen: boolean, toggleMenu: () => void }) {
    return (
        <div onClick={toggleMenu}>
            {isOpen ? <X /> : <svg className="block lg:hidden cursor-pointer" width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
